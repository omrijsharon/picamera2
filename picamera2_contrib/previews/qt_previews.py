...
class QtPreviewBase:
    ...
    def thread_func(self, previewcreateq):
        ...
        def createpreview(parent, cam, previewretrieveq):
            ...
            if parent.x is not None and parent.y is not None:
                qpicamera2_contrib.move(parent.x, parent.y)
            qpicamera2_contrib.setWindowTitle(parent.get_title())
            qpicamera2_contrib.show()
    ...
    def set_overlay(self, overlay):
        self.qpicamera2_contrib.set_overlay(overlay)

    def set_title_function(self, function):
        self.qpicamera2_contrib.title_function = function
