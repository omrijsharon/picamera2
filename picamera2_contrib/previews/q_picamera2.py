    ...
    class QPicamera2(QGraphicsView):
        ...
        def image_dimensions(self):
            ...
            if camera_config and camera_config['display'] is not None:
                ...
                size = (self.picamera2_contrib.stream_map[camera_config['display']].configuration.size.width,
                        self.picamera2_contrib.stream_map[camera_config['display']].configuration.size.height)
