...
class Process:
    ...
    def send(self, request: picamera2_contrib.request.CompletedRequest, **kwargs):
        """
...
class _RemoteProcess(mp.Process):
    ...
    def __init__(
        ...
        self._buffer_cache = {}
        self._request = None
        self._helper = picamera2_contrib.request.Helpers(_RemotePicamera2(picam2))
...
class RemoteRequest:
    ...
    def __init__(self, request: picamera2_contrib.request.CompletedRequest, **kwargs):
...
class _RemotePicamera2:
    ...
    def __init__(self, picam2: picamera2_contrib.Picamera2):
